...
public class EmployeeSortComparator {
	...
	public static void main(String[] args)
	{
		...
		empList.add(new Employee1(101,"John",50000));
		empList.add(new Employee1(102,"Jake",60000));
		empList.add(new Employee1(103,"Mike",55000));
		empList.add(new Employee1(104,"Allen",75000));
		empList.add(new Employee1(105,"Bob",45000));
